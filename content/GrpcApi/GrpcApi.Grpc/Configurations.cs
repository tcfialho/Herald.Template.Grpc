...
namespace GrpcApi.Grpc
{
    public static class Configurations
    {
        ...
        public static void MapGrpcApis(this IEndpointRouteBuilder endpoint, Assembly assembly)
        {
            if (assembly is null)
            {
            ...
            {
                var methodInfo = typeof(GrpcEndpointRouteBuilderExtensions).GetMethod(nameof(GrpcEndpointRouteBuilderExtensions.MapGrpcService));
